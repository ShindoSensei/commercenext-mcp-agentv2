    ...
    API: {
      ...
      streamResponse: async function(userMessage, conversationId, messagesContainer) {
        ...
        try {
          ...
          const streamUrl = 'https://commercenext-mcp-agent.onrender.com/chat';
      ...
      fetchChatHistory: async function(conversationId, messagesContainer) {
        try {
          ...
          const historyUrl = `https://commercenext-mcp-agent.onrender.com/chat?history=true&conversation_id=${encodeURIComponent(conversationId)}`;
    ...
    Auth: {
      ...
      startTokenPolling: function(conversationId, messagesContainer) {
        ...
        const poll = async () => {
          ...
          try {
            const tokenUrl = 'https://commercenext-mcp-agent.onrender.com/auth/token-status?conversation_id=' +
